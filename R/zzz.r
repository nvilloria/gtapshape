.onAttach <- function(libname, pkgname) {
 ...
 ## (source-code GEMPACK and a fortran compiler are needed for compiling the programs---they should be available in PATH, and the user is responsible for all the required licenses.)

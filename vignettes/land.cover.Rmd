...
The potential vegetation data are from \href{https://doi.org/10.1029/1999GB900046}{Ramankutty and Foley (1999)}. The original raster data is categorical, displaying 13 different potential vegetation classes. The specific raster used in this vignette was downloaded in ASCII format from:\href{https://sage.nelson.wisc.edu/data-and-models/datasets/global-potential-vegetation-dataset/}{https://sage.nelson.wisc.edu/data-and-models/datasets/global-potential-vegetation-dataset/}. 

For our analyses, we collapse the original 13 classes into 4 categories: "Forests", "Shrubland", "Savanna + Grassland", and "Other Lands" as in \href{https://gtap.agecon.purdue.edu/resources/res_display.asp?RecordID=5424}{Baldoz (2017)}.  
```{r, eval = FALSE}
...
The cropland and pastureland data are described in the paper by \href{https://doi.org/10.1029/2007GB002952}{Ramankutty et al. (2008)}, titled "Farming the planet: 1. Geographic distribution of global agricultural lands in the year 2000." The cropland and pastureland raster data are categorical in nature, with cell values indicating whether the fraction of cell area categorized as cropland or pastureland at a 5 minute resolution. The two rasters used in this vignette, one for cropland and the other for pastureland, were downloaded from \href{http://www.earthstat.org/cropland-pasture-area-2000/}{http://www.earthstat.org/cropland-pasture-area-2000/}. 

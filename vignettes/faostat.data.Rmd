...
############################################################
## DOWNLOAD AND CLEAN FAOSTAT DATA ON AG.PRODUCTION AND AREA:
############################################################
...
############################################################
## CROP PRODUCTION AND HARVESTED  AREA
############################################################
...
############################################################
## DOWNLOAD AND CLEAN FAOSTAT DATA ON PRODUCER PRICES (FOR VALUE OF
## PRODUCTION):
############################################################
...
######################################################################
## LIVESTOCK PRODUCTION (STANDING ANIMALS (HEADS), AGGREGATED TO GTAP
## SECTORS)
######################################################################
...
######################################################################
## LIVESTOCK OUTPUT VALUE. RMK & WOL: BASED ON PRODUCTS FOR WHICH
## PRICES EXIST; CTL: BASED ON GTAP PRICES.  [Micah, is this right?]
## (AGGREGATED TO GTAP SECTORS)
######################################################################
iso.rmk.and.wol.outputvalue.2011.2022 <-  fao_production %>%
    ## Use the livestock.concordance to select animal products fow

...
A set of XX functions carry the work of combining the time-invariant
...
lapply( aez18, function(.x){
    length(unique(.x$reg))
    setdiff(
        regional.concordance$reg,
        unique(.x$reg)
    )
})
...
gsc3.by.iso.ordered <- order.gsc3.by.iso(gsc3.by.iso, 
                              gtap_basedatasets_file = "C:/Users/Micah/Dropbox/REPOS/rentcalc/in/gsdgset.har",
                              subnat_bound_file="aez18")
```

## Write har file containing shared out land use and land cover data:
```{r, eval = FALSE}
write.gtaplulc.har(gsc3.by.iso.ordered, file="C:/Users/Micah/Dropbox/REPOS/gtapshape/gtaplulc.har")
```

## Write a har file containing the necessary sets:
```{r, eval = FALSE}
write.gtaplulcsets.har(gtap_basedatasets_file = "C:/Users/Micah/Dropbox/REPOS/rentcalc/in/gsdgset.har",
                       subnat_bound_file="aez18",
                       file = 'C:/Users/Micah/Dropbox/REPOS/gtapshape/gtaplulcsets.har')
```

## Write aggregation file as .txt file
```{r, eval = FALSE}
write.gtaplulcagg.txt(subnat_bound_file="aez18",
                      base_aggr_file = "C:/Users/Micah/Dropbox/REPOS/BIOMEmod_base.txt",
                      file = 'C:/Users/Micah/Dropbox/REPOS/gtapshape/gtaplulcagg.txt')
```
---
title: "2020 CROPGRIDS Data"
author: "Micah Cameron-Harp and Nelson Villoria"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %/VignetteIndexEntry{2020 CROPGRIDS Data}
...
#Load in one crop to check .nc file types are effectively loaded by terra package.
  abaca_2020 <- terra::rast("C:/Users/Micah/Dropbox/CGE_BIOMES_Carbon_2024/Raw data/CROPGRIDSv1.08_NC_maps/CROPGRIDSv1.08_abaca.nc")
  abaca_2020
```
...
setwd("C:/Users/Micah/Dropbox/REPOS/gtapshape")
devtools::document()
...
#Now make a list of all the files, make sure they have some properties as current data, and save as dataframes in .rda format. 
  #List files
  CROPGRIDS.file.list <- list.files(path = "C:/Users/Micah/Dropbox/CGE_BIOMES_Carbon_2024/Raw data/CROPGRIDSv1.08_NC_maps/",
                                     pattern = ".nc",
                                     full.names = TRUE)

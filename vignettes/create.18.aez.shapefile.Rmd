...
This vignette walks through the creation of the raster data depicting 18 Agro-Ecological Zones (AEZ) included in this package. To define the 18 AEZs, we follow the procedure used to create version 11 of the GTAP-AEZ Land Use and Land Cover database described in \href{https://www.gtap.agecon.purdue.edu/resources/res_display.asp?RecordID=7407}{Baldoz and Corong (2025)}. We use publicly available spatial data on the length of the growing period (LGP) and the thermal climate. Both of these datasets are available as rasters at \href{https://gaez.fao.org/pages/data-viewer}{https://gaez.fao.org/pages/data-viewer}. We use the LGP and thermal zone data from 1981 to 2010 produced with the CRUTS32 Climate Model to create the 18 AEZ map in our package. The LGP raster we use contains the total number of growing period days, and the Thermal Zones raster from the Climate Classification sub-theme to determine thermal climates. Both of these rasters will be downloaded when the \link[gtapshape]{getrawdata} function is executed. Note, the same procedure we describe below could be used to create maps using more recent data.

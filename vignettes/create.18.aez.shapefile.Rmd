...
#Verify that 'raw_data' folder containing the necessary spatial files has been downloaded
...
```{r, eval = FALSE}
  ...
  #Recode the lgd raster so there are 36 categories defined by 10 degree intervals

...
This vignette walks through the creation of the raster data depicting 18 Agro-Ecological Zones (AEZ) included in this package. To define the 18 AEZs, we use publicly available spatial data on the length of the growing period (LGP) and the thermal climate. Both of these datasets are available as rasters at https://gaez.fao.org/pages/data-viewer. We use the LGP and thermal climate data from 1981 to 2010 to create the 18 AEZ map in our package. Both of these rasters will be downloaded when the \link[gtapshape]{getrawdata} function is executed. Note, the same procedure we describe below could be used to create maps using more recent data.
...
#Load in length of growing season data
    lgd <- terra::rast("C:/Users/Micah/Dropbox/CGE_BIOMES_Carbon_2024/Raw data/Total number of growing period days_1981 to 2010/lgd_CRUTS32_Hist_8110.tif")
...
```{r, eval = FALSE}
  #Thermal Zones
    mc2 <- terra::rast("C:/Users/Micah/Dropbox/CGE_BIOMES_Carbon_2024/Raw data/Thermal zones/mc2_CRUTS32_Hist_8110.tif")
